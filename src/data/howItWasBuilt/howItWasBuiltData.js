import historyImage01Large from "../../assets/images/history-class/large-images/img01.png";
import historyImage01Small from "../../assets/images/history-class/small-images/img01.jpg";
import historyImage02Large from "../../assets/images/history-class/large-images/img02.png";
import historyImage02Small from "../../assets/images/history-class/small-images/img02.jpg";
import historyImage03Large from "../../assets/images/history-class/large-images/img03.png";
import historyImage03Small from "../../assets/images/history-class/small-images/img03.jpg";
import historyImage04Large from "../../assets/images/history-class/large-images/img04.png";
import historyImage04Small from "../../assets/images/history-class/small-images/img04.jpg";
import historyImage05Large from "../../assets/images/history-class/large-images/img05.png";
import historyImage05Small from "../../assets/images/history-class/small-images/img05.jpg";
import historyImage06Large from "../../assets/images/history-class/large-images/img06.png";
import historyImage06Small from "../../assets/images/history-class/small-images/img06.jpg";
import historyImage07Large from "../../assets/images/history-class/large-images/img07.png";
import historyImage07Small from "../../assets/images/history-class/small-images/img07.jpg";
import historyImage08Large from "../../assets/images/history-class/large-images/img08.png";
import historyImage08Small from "../../assets/images/history-class/small-images/img08.jpg";
import historyImage09Large from "../../assets/images/history-class/large-images/img09.png";
import historyImage09Small from "../../assets/images/history-class/small-images/img09.jpg";
import historyImage10Large from "../../assets/images/history-class/large-images/img10.png";
import historyImage10Small from "../../assets/images/history-class/small-images/img10.jpg";
import historyImage11Large from "../../assets/images/history-class/large-images/img11.png";
import historyImage11Small from "../../assets/images/history-class/small-images/img11.jpg";
import historyImage12Large from "../../assets/images/history-class/large-images/img12.png";
...
import historyImage16Small from "../../assets/images/history-class/small-images/img16.jpg";
import historyImage17Large from "../../assets/images/history-class/large-images/img17.png";
import historyImage17Small from "../../assets/images/history-class/small-images/img17.jpg";
import historyImage18Large from "../../assets/images/history-class/large-images/img18.png";
...
import historyImage22Small from "../../assets/images/history-class/small-images/img22.jpg";
import historyImage23Large from "../../assets/images/history-class/large-images/img23.png";
...
اولین نسخه‌ی ایده رو خیلی ساده توی Paint کشیدم و این شد اولین دیزاین اولیه پروژه.`,
            ...
            image: {
                src: historyImage01Small,
                lightboxSrc: historyImage01Large,
                alt: "Portfolio history image 01",
            },
            accent: "#78a9ff",
        },
        {
...
The design was something I was excited to build myself. I also had some experience creating objects with perspective, so I didn’t see it as completely out of my reach.
...
دیزاین چیزی بود که خودم برای ساختنش هیجان داشتم. تجربه‌ی ساخت اجسام با پرسپکتیو هم داشتم و کامل خارج از توانم نمی‌دیدم.

پس حالا که دیزاین و ویژن رو داشتم، می‌تونستم پروژه رو شروع کنم.`,
                },
            },
            image: {
                src: historyImage02Small,
                lightboxSrc: historyImage02Large,
                alt: "Portfolio history image 02",
            },
            accent: "#b78cff",
        },
        {
            ...
            translations: {
                en: {
                    title: "Shaping the Heart of the Project",
                    description: `With ChatGPT image generation, I built the shelf. It took a lot of back and forth and changes to create something that matched the design and what I wanted, but in the end it gave me something that felt perfect to me.

I brought the image into Photoshop and removed its background. I wanted the shadow and glowing reflection of the shelf to be visible on the floor, so I created a gradient over part of the ground that made the floor background color become transparent inside the gradient. That way, it looked like the shadow was actually on the floor, and it felt natural that the shelf was really placed there with its reflection on the ground.`,
                },
                fa: {
                    title: "ساخت قلب پروژه",
                    description: `با کمک image generation چت‌جی‌پی‌تی شلف رو ساختم. برای ساخت چیزی که توی دیزاین بود و خودم می‌خواستم، کلی بالا و پایین و تغییرات لازم بود، ولی در نهایت چیزی داد که به نظرم پرفکت بود.

عکس رو توی فتوشاپ بردم و بک‌گراندش رو جدا کردم. می‌خواستم روی زمین، سایه و بازتاب درخشان شلف معلوم باشه، پس اومدم توی یه محوطه از روی زمین، یه حالت گرادینت ایجاد کردم که رنگ بک‌گراند زمین داخل گرادینت ترنسپرنت بشه و انگار واقعا این سایه روی زمین هست و به چشم طبیعی بیاد که شلف واقعا روی زمین قرار داره و بازتابش هم روی زمین هست.`,
                },
            },
            image: {
                src: historyImage03Small,
                lightboxSrc: historyImage03Large,
                alt: "Portfolio history image 03",
            },
            accent: "#48d7c7",
        },
        {
            ...
            translations: {
                en: {
                    title: "Placing the Heart of the Project",
                    description: `First, I finalized the background animation so its color would change very slowly with a subtle flicker. Not too lifeless, not too distracting.

Then I placed the shelf image in the middle of the page and tried to build the ground.

I used a good dominant color for the ground so the colors of the floor, the image, and the background would blend together better, and it would not be easy to see where the image starts and where it ends.

I also added a gradient between the ground and the background so the sharp edge between them would not distract the eye.

Then I just placed the shelf items on the page.

Now it was time to arrange them.`,
                },
                fa: {
                    title: "قرار دادن قلب پروژه",
                    description: `اول حالت انیمیشن بک‌گراند رو نهایی کردم که رنگش خیلی آروم و سوسو کنان تغییر بکنه. نه خیلی بی‌روح باشه، نه حواس‌پرت‌کن.

بعد عکس شلف رو وسط صفحه گذاشتم و سعی کردم زمین رو بسازم.

برای زمین از یه رنگ غالب خوب استفاده کردم تا رنگ‌های زمین، عکس و بک‌گراند بهتر با هم حل بشن و به‌راحتی معلوم نباشه عکس از کجا شروع می‌شه و کجا تموم می‌شه.

یه گرادینت هم برای مرز زمین تا بک‌گراند دادم که تیزی مرزشون حواس رو پرت نکنه.

بعد آیتم‌های شلف رو فقط روی صفحه گذاشتم.

حالا نوبت چیدنشون بود.`,
                },
            },
            image: {
                src: historyImage04Small,
                lightboxSrc: historyImage04Large,
                alt: "Portfolio history image 04",
            },
            accent: "#ff9d66",
        },
        {
...
But in the end, I got to something that felt almost okay to me.

I realized that each row unfortunately needs its own custom values.

At this stage, I only used the Things I’ve Built row as my working reference and just tried to get its overall feel right.
...
ولی در نهایت به چیزی رسیدم که به نظرم تقریبا اوکی بود.

فهمیدم هر سطر متاسفانه نیاز به مقادیر کاستوم خودش داره.

تو این مرحله فعلا فقط ردیف Things I’ve Built رو الگوی کارم قرار دادم و فقط سعی کردم کلیت اون رو درست کنم.

تا بعدا برم و برای هر شلف مقدار درست به دست بیارم.`,
                },
            },
            image: {
                src: historyImage05Small,
                lightboxSrc: historyImage05Large,
                alt: "Portfolio history image 05",
            },
            accent: "#f47caa",
        },
        {
...
I also realized that the height of the cards in each row needed to be different too.

Then I added the infinite card behavior, the acceleration and natural dragging behavior of the cards, and the shadow at the start and end of each row.
...
و فهمیدم ارتفاع کارت‌های ردیف‌ها هم لازمه متفاوت باشه.

بعد قابلیت بی‌نهایت بودن کارت‌ها، شتاب و رفتار طبیعی کشیدن کارت‌ها، و سایه‌ی شروع و پایان ردیف رو اضافه کردم.

سرعت حرکت کارت‌ها و مقدار اصطکاک پرت شدن کارت‌ها، به نظرم طبیعی و فان شده بود.`,
                },
            },
            image: {
                src: historyImage06Small,
                lightboxSrc: historyImage06Large,
                alt: "Portfolio history image 06",
            },
            accent: "#63c5ff",
        },
        {
...
الان برای اولین بار می‌شد واقعا دید که چه چیز خوشگلی خواهد شد!`,
                },
            },
            image: {
                src: historyImage07Small,
                lightboxSrc: historyImage07Large,
                alt: "Portfolio history image 07",
            },
            accent: "#8fdb78",
        },
        {
...
Then I changed the image formats to jpg, kept their sizes roughly around 4 to 9 kilobytes, and compressed them properly.

Now my project was not just a single blue color anymore. It felt like it had gained a soul, like it had earned badges of honor :)
...
بعد پسوند عکس‌ها رو jpg کردم و حجمشون رو تو رنج تقریبی ۴ تا ۹ کیلوبایت نگه داشتم و حسابی کامپرسشون کردم.

الان پروژه‌م دیگه فقط یه تک‌رنگ آبی‌ نبود. انگار روح گرفته بود، بج‌های آنر گرفته بود :)

و نمی‌دونم چرا این اسکرین‌شات این‌قدر روشن‌تر از بقیه‌ست... ولی باحال شده :)`,
                },
            },
            image: {
                src: historyImage08Small,
                lightboxSrc: historyImage08Large,
                alt: "Portfolio history image 08",
            },
            accent: "#ffd166",
        },
        {
            ...
            translations: {
                en: {
                    ...
                    description: `This was where the most complicated change in the project happened. It is not really visible in the design, but I made all the items inside the shelf use cqw!

Basically, the size of every item inside the shelf became dependent on the size of the shelf parent. This helped me finally implement a feature I was really stressed about, in a very clean way. The project would always look the way it was designed, on any screen, monitor, or zoom level.

Then I made the size of the shelf parent div depend on the width and height of the monitor, so changing the zoom or the screen could no longer break the shelf, or make it and its items too small or too big!

Oh, and yeah, I also filled the left side of the page.`,
                },
                fa: {
                    title: "Wingardium Leviosa",
                    description: `اینجا پیچیده‌ترین تغییر پروژه رخ داد. این تغییر تو ظاهر قابل‌تشخیص نیست. کاری کردم تمامی آیتم‌های داخل شلف، همشون از cqw استفاده کنن!

یعنی اندازه‌ی تمامی آیتم‌های داخل شلف وابسته به اندازه‌ی پرنت شلف بود. این باعث شد بتونم فیچری که خیلی براش استرس داشتم رو بالاخره خیلی تمیز پیاده کنم. اینکه پروژه تو هر صفحه، مانیتور و زومی، همیشه اون‌جور که طراحی شده نشون داده بشه.

بعد اندازه‌ی div پرنت شلف رو وابسته به عرض و ارتفاع مانیتور کردم و دیگه تغییر زوم و مانیتور نمی‌تونست باعث خراب شدن، خیلی کوچیک شدن یا خیلی بزرگ شدن شلف یا آیتم‌هاش بشه!

آهان و آره، قسمت چپ صفحه هم پر کردم.`,
                },
            },
            image: {
                src: historyImage09Small,
                lightboxSrc: historyImage09Large,
                alt: "Portfolio history image 09",
            },
            accent: "#ae96ff",
        },
        {
...
پس این یه تست ناموفق و باحال بود و دیدم نیاز بود تو دیزاین پروژه دست ببرم.`,
            ...
            image: {
                src: historyImage10Small,
                lightboxSrc: historyImage10Large,
                alt: "Portfolio history image 10",
            },
            accent: "#56e0d2",
        },
        {
...
عکس جدید دیزاین رو با چت‌جی‌پی‌تی ساختم و شروع به ساختنش کردم.`,
            ...
            image: {
                src: historyImage11Small,
                lightboxSrc: historyImage11Large,
                alt: "Portfolio history image 11",
            },
            accent: "#78a9ff",
        },
        {
...
کارت‌های Career رو طبق دیزاین بهتر کردم. دیگه فقط یه عکس و متن زیرش نبود. شبیه دیزاین جدید، بهتر و حرفه‌ای‌تر و خوشگل‌تر شد.`,
            ...
            image: {
                src: historyImage12Small,
                lightboxSrc: historyImage12Large,
                alt: "Portfolio history image 12",
            },
            accent: "#b78cff",
        },
        {
...
به نظرم ایده خلاقانه و خوبی میومد. با چت‌جی‌پی‌تی دیزاین تقریبی و قرارگیری قسمت‌های داخلش رو ساختم و پلن خوبی برای ادامه دادن داشتم.`,
            ...
            image: {
                src: historyImage13Small,
                lightboxSrc: historyImage13Large,
                alt: "Portfolio history image 13",
            },
            accent: "#48d7c7",
        },
        {
...
خیلی خوشحال بودم که گنگی‌ای که از اول پروژه برای قرار دادن این فیچر داشتم، بالاخره حل شده بود :)`,
            ...
            image: {
                src: historyImage21Small,
                lightboxSrc: historyImage21Large,
                alt: "Portfolio history image 21",
            },
            accent: "#56e0d2",
        },
        {
...
export default howItWasBuiltData;
